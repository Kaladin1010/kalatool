...
os.system(f'cls & mode 85,20 & title [KalaTool] - Raid')

print(f"""\n{Fore.LIGHTWHITE_EX }[{Fore.LIGHTWHITE_EX }+{Fore.LIGHTWHITE_EX }] Saisissez le token du bot que vous utiliserez pour exécuter les commandes RAID :""")
token = input(f"""{Fore.LIGHTWHITE_EX }[{Fore.LIGHTBLUE_EX }#{Fore.LIGHTWHITE_EX }] Token: """)
...
class Nuker:
        ...
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.LIGHTWHITE_EX }[{self.colour}+{Fore.LIGHTWHITE_EX }] Banni {member.strip()}")
                    break
                else:
                    break
    ...
    def KickMembers(self, guild, member):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.LIGHTWHITE_EX }[{self.colour}+{Fore.LIGHTWHITE_EX }] Kick {member.strip()}")
                    break
                else:
                    break
    ...
    def DeleteChannels(self, guild, channel):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.LIGHTWHITE_EX }[{self.colour}+{Fore.LIGHTWHITE_EX }] Channel supprimée {channel.strip()}")
                    break
                else:
                    break
    ...
    def DeleteRoles(self, guild, role):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.LIGHTWHITE_EX }[{self.colour}+{Fore.LIGHTWHITE_EX }] Role supprimée {role.strip()}")
                    break
                else:
                    break
    ...
    def SpamChannels(self, guild, name):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.LIGHTWHITE_EX }[{self.colour}+{Fore.LIGHTWHITE_EX }] Channel créée {name}")
                    break
                else:
                    break
    ...
    def SpamRoles(self, guild, name):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.LIGHTWHITE_EX }[{self.colour}+{Fore.LIGHTWHITE_EX }] Role créée {name}")
                    break
                else:
                    break

    async def Scrape(self):
        guild = input(f'{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] ID du serveur: ')
        ...
        with open('temp/Scraped/members.txt', 'a') as m:
            for member in members:
                ...
                membercount += 1
            print(f"\n{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] Scraped {membercount} Membres")
            m.close()
    ...
    async def NukeExecute(self):
        guild = input(f'{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] ID du serveur: ')
        channel_name = input(f"{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] Nom du channel: ")
        channel_amount = input(f"{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] Nombre de channel: ")
        role_name = input(f"{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] Nom du role: ")
        role_amount = input(f"{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] Nombre de role: ")
        print()
    ...
    async def ChannelSpamExecute(self):
        guild = input(f'{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] ID du serveur: ')
        name = input(f"{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] Nom du channel: ")
        amount = input(f"{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] Nombre: ")
        print()
    ...
    async def RoleSpamExecute(self):
        guild = input(f'{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] ID du serveur: ')
        name = input(f"{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] Nom du role: ")
        amount = input(f"{Fore.LIGHTWHITE_EX }[{self.colour}#{Fore.LIGHTWHITE_EX }] Combien: ")
        print()
        for i in range(int(amount)):
    ...
    async def ThemeChanger(self):
        os.system(f'cls & mode 85,20 & title [KalaTool] - Themes')
        print(f'''
      {self.colour}╔═══════════════════════╦═══════════════════════╦═══════════════════════╗\033[37m
    ...
    async def Menu(self):
        os.system(f'cls & mode 85,20 & title [KalaTool] - Connected: {client.user}')
        print(f'''
      {self.colour}╔═══════════════════════╦═══════════════════════╦═══════════════════════╗\033[37m
      ...
      {self.colour}║ {Fore.LIGHTWHITE_EX }[{self.colour}3{Fore.LIGHTWHITE_EX }] \033[37mPrune Members     {self.colour}║\033[37m {Fore.LIGHTWHITE_EX }[{self.colour}7{Fore.LIGHTWHITE_EX }] \033[37mCreate Channels   {self.colour}║\033[37m {Fore.LIGHTWHITE_EX }[{self.colour}X{Fore.LIGHTWHITE_EX }] \033[37mExit              {self.colour}║\033[37m
      {self.colour}║ {Fore.LIGHTWHITE_EX }[{self.colour}4{Fore.LIGHTWHITE_EX }] \033[37mDelete Roles      {self.colour}║\033[37m {Fore.LIGHTWHITE_EX }[{self.colour}8{Fore.LIGHTWHITE_EX }] \033[37mNuke Server       {self.colour}║\033[37m {Fore.LIGHTWHITE_EX } {self.colour} {Fore.LIGHTWHITE_EX }  \033 3                  {self.colour}║\033[37m
      {self.colour}╚═══════════════════════╩═══════════════════════╩═══════════════════════╝\033[37m
        \033[37m''')
